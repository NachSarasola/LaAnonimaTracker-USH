...
def main() -> int:
    ...
    try:
        ...
        _run_cmd(_cli_cmd(args.config, "ipc-sync", "--region", "all"), env)
        _run_cmd(_cli_cmd(args.config, "ipc-publish", "--basket", args.basket, "--region", "patagonia"), env)
        _run_cmd(_cli_cmd(args.config, "ipc-publish", "--basket", args.basket, "--region", "nacional"), env)
        _run_cmd(
            _cli_cmd(
                args.config,
                "publish-web",
